<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\www.project.com\public/../application/home\view\order\create.html";i:1552128661;s:52:"D:\www.project.com\application\home\view\layout.html";i:1550986512;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="cart py-container">
				...
				<div class="addressInfo">
					<ul class="addr-detail">
						...
						<li class="addr-item" address_id="<?php echo $v['id']; ?>">
							<div class="con name <?php if(($k == 0)): ?>selected<?php endif; ?>"><a href="javascript:;"><em><?php echo $v['consignee']; ?></em><span title="点击取消选择">&nbsp;</span></a></div>
						...
						<li>
							...
							<div class="sendGoods">
								...
								<ul class="yui3-g">
									...
									<li class="yui3-u-1-12">
										<div class="exit"><?php if(($v['goods_number'] > $v['number'])): ?>有货<?php else: ?>缺货<?php endif; ?></div>
									</li>
								</ul>
								<?php endforeach; ?>
							</div>
	...
	<div class="clearfix trade">
		...
		<div class="fc-receiverInfo">寄送至:<?php echo $address[0]['address']; ?> 收货人：<?php echo $address[0]['consignee']; ?> <?php echo $address[0]['phone']; ?></div>
	</div>
	<div class="submit">
...
<script>
	$(function () {
		//给地址绑定点击事件
		$('.name').click(function () {
			//获取点击的地址 收货人、收货地址、手机号
			var consignee = $(this).closest('li').find('.consignee_name').html();
			var address = $(this).closest('li').find('.consignee_address').html();
			var phone = $(this).closest('li').find('.consignee_phone').html();
			//显示到页面下方 提交订单位置
