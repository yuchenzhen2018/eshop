<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\www.project.com\public/../application/home\view\goods\detail.html";i:1551331231;s:52:"D:\www.project.com\application\home\view\layout.html";i:1550986512;}*/ ?>
<!DOCTYPE html>
<html>
				...
				<div class="py-container">
					<div class="shortcut">
						<ul class="fl">
	                        ...
	                        <li class="f-item">Hi,<a href="javascript:;" ><?php echo encrypt_phone(\think\Session::get('user_info.phone')); ?></a>　<span><a href="<?php echo url('home/login/logout'); ?>">退出</a></span></li>
	                        <?php elseif((\think\Session::get('user_info.email'))): ?>
	                        <li class="f-item">Hi,<a href="javascript:;" ><?php echo \think\Session::get('user_info.email'); ?></a>　<span><a href="<?php echo url('home/login/logout'); ?>">退出</a></span></li>
	                        <?php else: ?>
	                        <li class="f-item">Hi,<a href="javascript:;" ><?php echo \think\Session::get('user_info.username'); ?></a>　<span><a href="<?php echo url('home/login/logout'); ?>">退出</a></span></li>
	                        <?php endif; ?>
						</ul>
						<ul class="fr">
		...
		<div id="item">
			...
			<div class="product-info">
				...
				<div class="fr itemInfo-wrap">
					...
					<div class="news"><span><?php echo $goods['goods_introduce']; ?></span></div>
					<div class="summary">
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							<?php foreach($attribute as $attr): if($attr['attr_type'] == 1): ?>
							<dl>
								<dt>
									<div class="fl title">
										<i><?php echo $attr['attr_name']; ?></i>
									</div>
								</dt>
								<?php foreach($new_goodsattr[$attr['id']] as $k=>$v): ?>
								<dd>
									<a goods_attr_id="<?php echo $v['id']; ?>" href="javascript:;" class="<?php if($k == 0): ?>selected<?php endif; ?>"><?php echo $v['attr_value']; ?><span title="点击取消选择">&nbsp;</span></a>
								</dd> 
								<?php endforeach; ?>
							</dl>
							...
							<ul class="goods-list unstyled">
								...
								<li>
									<div class="list-wrap">
										...
										<div class="operate">
											<a href="javascript:void(0);" id="addcart" class="sui-btn btn-bordered">加入购物车</a>
										</div>
									</div>
								</li>
								<li>
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								...
								<div class="intro-detail">
									<img src="/static/home/img/_/intro01.png" />
									<img src="/static/home/img/_/intro02.png" />
									<img src="/static/home/img/_/intro03.png" />
								</div>
							</div>
         ...
         <!-- 添加一个form表单,把goodsid 和数量以及属性值传到后台 -->
	 ...
	 */
	 $(function(){
		...
		$('#addshopcar').click(function(){
           ...
           //获取选中的属性值ids,放到form表单中
           var selected_a = $('.selected');
           // console.log(selected_a);
           var goods_attr_ids = '';
           //遍历取出所有的id属性值
           $.each(selected_a,function(i,v){
